...
?>
	  <?php echo do_shortcode('[wp_custom_image_category  size="full" term_id="'.$category[0]->cat_ID.'" ]');  ?>
	</section>
		...
		<div class="col-md-8 col-xs-12 left-panel">
			...
			<div class="breadcrumbs" typeof="BreadcrumbList" vocab="http://schema.org/">
				...
				<div class="block clearfix">
			        <?php
					the_archive_title( '<h1 class="clearfix entry-title"><span class="title-black blue">', '</span></h1>' );
